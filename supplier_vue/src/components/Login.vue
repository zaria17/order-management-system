        ...
        <div class="loginDiv">
            <div class="login-content">
                ...
                <el-form :model="loginForm" label-width="100px"
                    ...
                    <el-form-item label="账号" prop="供应商id">
                        <el-input style="width: 200px" type="text" v-model="loginForm.供应商id"
...
<script>
    export default {
        ...
        methods:{
          ...
          doSave(){
            this.$axios.post('http://localhost:8090/供应商/save', this.form).then(res => res.data).then(res => {
              console.log(res)
              this.tableData = res
              if (res.code = 200) {
                //alert('suc')
            ...
            confirm(){
                ...
                this.$refs.loginForm.validate((valid) => {
                    if (valid) { //valid成功为true，失败为false
                        //去后台验证用户名密码
                        this.$axios.post('http://localhost:8090/供应商/login',this.loginForm).then(res=>res.data).then(res=>{
                            console.log(res)
                            if(res.code==200){
                                //存储
