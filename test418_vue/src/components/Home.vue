        ...
        methods:{
          mod() {
            ...
            this.$axios.post('http://localhost:8090/客户/listP2', {
              ...
              console.log(res)
              this.tableData = res
              console.log(this.tableData[0].地址)
              this.form.客户id = this.tableData[0].客户id
              ...
              this.form.传真 = this.tableData[0].传真
          ...
          save(){
            this.$axios.post('http://localhost:8090/客户/mod', this.form).then(res => res.data).then(res => {
              console.log(res)
              this.tableData = res
              if (res.code = 200) {
                //alert('suc')
